...
const createInnerHtml = () => {
    ...
    for (let employeePayrollData of employeePayrollList) {
        ...
        <tr>
            ...
            <td>
                <img id="${employeePayrollData._id}" onclick="remove(this)" alt="delete" src="C:\\Users\\user\\Desktop\\LFP_Batch\\Day45_Employee_Payroll_App\\assets\\Icon\\delete-black-18dp.svg">
                <img id="${employeePayrollData._id}" onclick="update(this)" alt="edit" src="C:\\Users\\user\\Desktop\\LFP_Batch\\Day45_Employee_Payroll_App\\assets\\Icon\\create-black-18dp.svg">
            </td>
        </tr>
        `;
    }
